...
export const thumbsUpSolidIcon = (
	<svg
		className="w-6 h-6"
		fill="currentColor"
		viewBox="0 0 20 20"
		xmlns="http://www.w3.org/2000/svg"
		dangerouslySetInnerHTML={{ __html: tui.html }}
	/>
)

const tur = icon({ prefix: "far", iconName: "thumbs-up" })

export const thumbsUpRegularIcon = (
	<svg
		className="w-6 h-6"
		fill="currentColor"
		viewBox="0 0 20 20"
		xmlns="http://www.w3.org/2000/svg"
		dangerouslySetInnerHTML={{ __html: tur.html }}
	/>
)
...
export const rotateRightIcon = (
	<svg
		...
		viewBox="0 0 20 20"
		xmlns="http://www.w3.org/2000/svg"
		dangerouslySetInnerHTML={{ __html: rri.html }}
	/>
)
...
export const arrowLeftIcon = (
	<svg
		...
		viewBox="0 0 20 20"
		xmlns="http://www.w3.org/2000/svg"
		dangerouslySetInnerHTML={{ __html: ccl.html }}
	/>
)
